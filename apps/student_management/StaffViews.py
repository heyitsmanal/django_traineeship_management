...
from apps.student_management.forms import ProjectValidationForm

from apps.student_management.models import  CustomUser, Day, Group, GroupSchedule, Note, Project, Staffs, Courses, Students, Attendance, AttendanceReport, StudentResult
