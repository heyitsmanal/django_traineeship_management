...
from apps.student_management.models import BlacklistedStudent, CustomUser, Day, Group, GroupSchedule, Project, Staffs, Courses, Students, Attendance, AttendanceReport, group_created_handler
